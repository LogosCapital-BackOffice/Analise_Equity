...
# vc bAIXOU A BIBLIOTECA ? Nao precisa, ja vem instalada no Spyder
# Teu codigo parece qboue funboa boa
# tava tentando isso
# acho que alguma coisa no site mudou, mas parece rapido de alterar
	if r:
